...
class AppRepository {
  AppRepository({
    required AppDataService appDataService,
  ...
  Future<List<NotificationModel>> getNotifications() => _appDataService.getNotifications();
  Future<List<NotificationModel>> getUnreadNotifications() => _appDataService.getUnreadNotifications();
  Future<int> getUnreadNotificationCount() => _appDataService.getUnreadNotificationCount();
  Future<NotificationModel> markNotificationRead(int id) => _appDataService.markNotificationRead(id);
  Future<void> markAllNotificationsRead() => _appDataService.markAllNotificationsRead();
  ...
  Future<EmployeeModel> createEmployee(Map<String, dynamic> payload) => _appDataService.createEmployee(payload);
  ...
  Future<List<DependentModel>> getDependents({int? employeeId, int? patientId}) =>
      _appDataService.getDependents(employeeId: employeeId, patientId: patientId);
  Future<DependentModel> createDependent(Map<String, dynamic> payload) =>
      _appDataService.createDependent(payload);
  Future<DependentModel> updateDependent(int id, Map<String, dynamic> payload) =>
  ...
  Future<int> getDoctorProfileIdForUser(int userId) => _appDataService.getDoctorProfileIdForUser(userId);
  Future<List<PrescriptionModel>> getPrescriptions({String? status}) =>
      _appDataService.getPrescriptions(status: status);
  Future<List<PrescriptionModel>> searchPrescriptions(String query) => _appDataService.searchPrescriptions(query);
  Future<PrescriptionModel> getPrescription(int id) => _appDataService.getPrescription(id);
  ...
  Future<List<MedicationModel>> getMedications() => _appDataService.getMedications();
  ...
  Future<List<InsuranceRequestModel>> getInsuranceRequests() => _appDataService.getInsuranceRequests();
  ...
  Future<InsuranceRequestModel> updateInsuranceRequest({
    ...
    required String notes,
      ...
      _appDataService.updateInsuranceRequest(id: id, status: status, notes: notes);
  ...
  Future<UserModel> createUser(Map<String, dynamic> payload) => _appDataService.createUser(payload);
