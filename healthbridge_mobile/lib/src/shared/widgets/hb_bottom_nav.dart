  ...
  List<_NavItem> _itemsForRole(String? role) {
    switch (role) {
      case AppRoles.doctor:
        return const [
          _NavItem('الرئيسية', DoctorHomeScreen.routePath, Icons.home_outlined, Icons.home_rounded),
          _NavItem(
            'الموظفون',
      ...
      case 'Patient':
        return const [
          _NavItem('الرئيسية', EmployeeHomeScreen.routePath, Icons.home_outlined, Icons.home_rounded),
          _NavItem(
            'الوصفات',
      ...
      case AppRoles.insuranceOfficer:
        return const [
          _NavItem('الرئيسية', InsuranceOfficerHomeScreen.routePath, Icons.home_outlined, Icons.home_rounded),
          _NavItem(
            'الطلبات',
          ...
          _NavItem('الحساب', ProfileScreen.routePath, Icons.person_outline_rounded, Icons.person_rounded),
        ];
      case AppRoles.pharmacist:
        return const [
          _NavItem('الرئيسية', PharmacistHomeScreen.routePath, Icons.home_outlined, Icons.home_rounded),
          _NavItem(
            'البحث',
      ...
      default:
        return const [
          _NavItem('الرئيسية', AdminHomeScreen.routePath, Icons.home_outlined, Icons.home_rounded),
          _NavItem(
            'المستخدمون',
